<template>
  <Modal :open="open" @close="$emit('close')">
    <div class="modal-body px-4" style="overflow: hidden">
      <div class="wallet-button" @click="handleLogin" :disabled="!service || isLoading">
        <div class="wallet-column py-4">
          ...
          <div class="flex-auto">Connect to your MetaMask Wallet</div>
        </div>
      </div>
      <br />
      <div class="wallet-button" @click="handleLogin" :disabled="!service || isLoading">
        <div class="wallet-column py-4">
          <svg viewBox="0 0 96 96" style="width: 52px">
          ...
          <div class="flex-auto py-2" style="color: black">TrustWallet</div>
          <div class="flex-auto">Connect to your Trust Wallet</div>
        </div>
